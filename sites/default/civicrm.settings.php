...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/drupal_test?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost:3306/drupal_test?new_link=true');
  }
}
...
$civicrm_root = 'F:/home/OpenServer/domains/drupal.test/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'F:/home/OpenServer/domains/drupal.test\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://drupal.test/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '38c0e347b22ae3a4a141dd1696b160b6');
}
...
// define( 'CIVICRM_MAIL_LOG', 'F:/home/OpenServer/domains/drupal.test\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
